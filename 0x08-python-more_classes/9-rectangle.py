#!/usr/bin/python3
"""Task 9 of ALX Project(Python - More Classes and Objects)
...
class Rectangle:
    ...
    def square(cls, size=0):
        """Return a Rectangle object that is a square of length ``size``

        Args:
            size(int): the length of the resulting square
